                ...
                if (MarketingDetails != null && MarketingDetails.Rows.Count > 0)
                {
                    ...
                    listMarketing = (from DataRow dr in MarketingDetails.Rows
                                     select new cg_Marketing()
                                     {
                                         ...
                                         Marketing_Start_Date = dr["Marketing_Start_Date"] is DBNull ? "" : Convert.ToString(dr["Marketing_Start_Date"]),
                                         ...
                                         Assignment_date = dr["Assignment_date"] is DBNull ? "" : Convert.ToString(dr["Assignment_date"]),
                                         ...
                                         Marketing_End_Date = dr["Marketing_End_Date"] is DBNull ? "" : Convert.ToString(dr["Marketing_End_Date"]),
